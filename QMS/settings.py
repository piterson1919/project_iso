...
MEDIA_ROOT = r"\\192.168.0.2\FISSA\IT\1 pruebas"
MEDIA_URL = '/media/'

SECRET_KEY = 'django-insecure-o!13rt&y3(obh0r+e5#6dje)_^wjy)vjgwyx6s0!^_ag)z&ii5'
DEBUG = True

# Aceptar peticiones desde cualquier IP (Electron + VM)
ALLOWED_HOSTS = ["*"]
...
CORS_ALLOWED_ORIGINS = [
    "http://192.168.0.116:5173",   # Frontend real en la VM
...
# Para evitar warnings si usas cookies (no obligatorio con TokenAuth)
